...
τ = 4e-5 # time step to include 50 steps every 10 picoseconds # sec # variable
ttotal = 0.017 # total time of evolution # sec #variable
...
Eνₑ =  0 # energy of all neutrinos (P.S the its negative is energy of all antineutrinos)
