...
function main(N; use_splitblocks = true, nsweeps, blas_num_threads,
    ...
    #uncommment this return command when runnning the loop_main_self_interactions.jl script 
    # return apply_time 
    
end 

# Comment out this whole chunk below when running the loop_main_self_interactions.jl script
N = 4 # number of sites 
println("Serial:\n")
