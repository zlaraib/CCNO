...
datadir = joinpath(@__DIR__,"datafiles", "Richers", "par_"*string(N_sites), "tt_"*string(ttotal))
...
if save_plots_flag 
    # Specify the relative directory path
    plotdir = joinpath(@__DIR__, "plots", "Richers", "par_"*string(N_sites), "tt_"*string(ttotal))  
