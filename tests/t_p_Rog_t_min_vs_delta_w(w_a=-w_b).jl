...
# Create the plot
plot(Δω_values, t_p_Rog_array, label="t_p_Rog", xlabel="Δω", ylabel="Minimum Time(t_p)", title="Running t_p_Rog_t_min_vs_delta_w(w_a=-w_b) script for N=4")
plot!(Δω_values, t_min_array, label="t_min")
savefig("t_p_Rog_t_min_vs_delta_w_(N=4).pdf")