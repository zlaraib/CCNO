...
N_start = 4  
N_stop = 24
file_path = f"misc/datafiles/Rog/N_start_{N_start}/N_stop_{N_stop}/Nvals_tpRog_tpmine.dat"
...
ax.set_title("Rogerro(2021) Fig. 3(b) for a symmetric $\delta_{\omega}$=$\mu / 4$", fontsize=24) 
plt.legend(frameon=False)
ax.grid(False)
plt.savefig("N_vs_t_p_for_symmetric_del_omega.pdf")
plt.show()
