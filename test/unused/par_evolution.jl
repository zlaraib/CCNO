...
x = CCNO.generate_x_array(N_sites, L)
...
p = hcat(CCNO.generate_px_array(N_sites, neutrino_energy, antineutrino_energy), CCNO.generate_py_array(N_sites), CCNO.generate_pz_array(N_sites))
