...
RUN julia -e 'push!(LOAD_PATH, "."); import Pkg; Pkg.add("CCNO"); Pkg.add("ITensors"); Pkg.add("ITensorMPS"); Pkg.add("Plots"); Pkg.add("Measures"); Pkg.add("LinearAlgebra"); Pkg.add("ITensorTDVP");Pkg.add("HDF5"); Pkg.precompile()'
